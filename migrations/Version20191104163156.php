...
");
                $this->addSql("INSERT INTO `design_tables_text_interfase` (`language`, `table_type`, `interface_name`, `item_name`, `text`) VALUES 
    ...
    public function down($schema)
    {
        ...
        switch ($this->db_type){
            case "mysql":{
                ...
                $this->addSql("delete from design_tables where table_name='slider'");
                $this->addSql("delete from design_tables_text_interfase where interface_name='slider'");
                break;
            }
            default:{
                throw new \Exception("the database {$this->db_type} is not supported !");
